//
//  HPBlurryStepOutAnimatedTransitioning.m
...
#import "HPBlurryStepOutAnimatedTransitioning.h"

@interface HPBlurryStepOutAnimatedTransitioning ()
...
@implementation HPBlurryStepOutAnimatedTransitioning
...
-(void)executePresentationAnimation:(id<UIViewControllerContextTransitioning>)transitionContext{
    ...
    [UIView animateKeyframesWithDuration:halfDuration delay:0.0 options:UIViewKeyframeAnimationOptionCalculationModeLinear animations:^{
        ...
        if (self.endColorBackground) {
            
            toViewController.view.backgroundColor = self.endColorBackground;
        }
        else {
